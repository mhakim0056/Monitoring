    ...
    <head>
        ...
        <title>Spyzie            - Video Preview - Live Demo</title>
...
<script src="https://statics.spyzie.com/js/lib/jquery-2.1.4.bootstrap.min.js?v=1516603721"></script>
    ...
    <meta name="csrf-token" content="oGf9BRsFlzC_bv0kTsFyMby4IKEkfSLkoTQsgD1tNiXINqxoUUPBW9BWj2Y6hEVL8-cR8EE2RbvnTW_OeDtMTw==">
    </head>
    <body>
    <div class="preloader">
    ...
    <div class="main_content ">
        <div class="main_header">
            <ul class="user-info-menu hidden-xs hidden-sm">
                ...
                </ul>                            <h1 class="column">Video Preview</h1>
                    </div>
...
<div id="images" class="panel panel-default" v-cloak>
    <div class="panel-body">
        <div class="detail_box message_detail list_detail" style="display:block;">
            <div class="box_cont">
                <div class="full-height-scroll" id="images_container">
                            ...
                            <dd>
                                <ul class="photo_list">
                                    <li v-for="item in group.data">
                                        <div class="pic">
                                            <div v-if="item.preview_imgs.length > 0">
                                                <a :href="item.preview_imgs[0]" :data-fancybox="'gallery' + item.id">
                                                    <span><img v-lazy="item.preview_imgs[0]"></span>
                                                </a>
                                                <i v-for="(img, key) in item.preview_imgs" v-if="key != 0" :href="img"
                                                   :data-fancybox="'gallery' + item.id"></i>
                                            </div>
                                            <a v-else :href="item.file_url" :data-fancybox="'gallery' + item.id"
                                               data-type="iframe">
                                                <span><img v-lazy="item.cover_img"></span>
                                                <i class="si si-play_arrow"></i>
                                            </a>
                                            <div class="info">
                                                <span class="time">{{ item.time }}</span>
                                                <a :href="item.download_url" :download="item.file_name"
                                                   class="btn_down hide">Download</a>
                                            </div>
                                        </div>
...
<script>
    var url = 'https://data-api.spyzie.com/v1/data/videos?s=e4BTmnFuys8ab6vLuiMyGBY4onGm3g8cL1j68NgSSXk&lang=en-US&ip=125.163.216.99&from_app=0&timestamp=1516671729656&vc=8d08c3bdca60ed72faa3caa4c1fe083d&key=DF57C5922C29CBA3D9F4B0234E5A8A55';
</script>
